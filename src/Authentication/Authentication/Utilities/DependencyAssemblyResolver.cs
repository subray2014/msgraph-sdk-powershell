...
namespace Microsoft.Graph.PowerShell.Authentication.Utilities
{
    public static class DependencyAssemblyResolver
    {
        ...
        private static IReadOnlyDictionary<string, Version> Dependencies = new Dictionary<string, Version>
        {
            ...
            { "Microsoft.IdentityModel.Abstractions", new Version("6.23.1") },
            { "Microsoft.IdentityModel.JsonWebTokens", new Version("6.23.1") },
            { "Microsoft.IdentityModel.Logging", new Version("6.23.1") },
            { "Microsoft.IdentityModel.Tokens", new Version("6.23.1") },
            { "System.IdentityModel.Tokens.Jwt", new Version("6.23.1") },
            { "System.Security.Cryptography.ProtectedData", new Version("6.0.0") },
            { "Newtonsoft.Json", new Version("13.0.1") },
            { "System.Text.Json", new Version("6.0.6") },
